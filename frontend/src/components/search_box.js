...
const SearchBox=()=>{
    ...
    return(
        <div className="relative">
            <div className={`relative w-[600px] h-6 flex flex-row py-[3px] px-2 rounded-full bg-white z-10`}>
            ...
            <div className={`absolute z-[9] top-[-2px] h-7 rounded-full bg-blue-600 transition-all duration-500 ease-in-out
                            ${searchBoxOnfocus ? 'w-[604px] left-[-2px]' : 'w-0 left-1/2'}`}></div>
            <div className='absolute z-[8] top-[-2px] left-[-2px] w-[604px] h-7 rounded-full bg-gray-300'></div>
        </div>
    );
};
